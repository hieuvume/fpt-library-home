          ...
          <div className="card pb-2.5">
            ...
            <Formik
              ...
              onSubmit={(values: any, { setSubmitting, setFieldError }) => {
                setSubmitting(true);
                userApi.updateProfile(values).then((data) => {
                  Report.success("Success", "Profile updated successfully!", "OK", () => {
                    console.log(data);
                    window.location.reload(); 
                  }); 
                }).catch((error) => {
                  Report.failure("Error", "Profile update failed!", "OK", () => {
                    setFieldError("email", error?.response?.data?.message || "Something went wrong");
                  });
                }).finally(() => {
                  setSubmitting(false);
                }
            ...
            >
              {({ setFieldValue }) => (
                <Form className="card-body grid gap-5">
                  ...
                  <div className="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                    <label className="form-label max-w-56">Card Number ID</label>
                    <Field className="input" name="id_card.id_number" type="text" />
                    <ErrorMessage name="id_card.id_number" component="div" className="text-red-500" />
                  </div>
                  <div className="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                    <label className="form-label max-w-56">Date of issue</label>
                    <Field
                      className="input"
                      name="id_card.date"
                      type="date"
                    ...
                    />
                    <ErrorMessage name="id_card.date" component="div" className="text-red-500" />
                  </div>

                  <div className="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5 mb-2.5">
                    <label className="form-label max-w-56">Place of issue</label>
                    <Field className="input" name="id_card.place" type="text" />
                    <ErrorMessage name="id_card.place" component="div" className="text-red-500" />
                  </div>
