...
import { formatCurrency, getBankQRCode, getMomoQRCode } from "@/utils"
import Image from "next/image"
import { Confirm, Report } from "notiflix"

const MomoPaymentGuide = ({ payment }: { payment: Payment }) => {
        ...
        <div className="grid gap-5 mb-2">
            <div className="flex flex-col">
                ...
                <div className="flex flex-center justify-center">
                    <Image src={getMomoQRCode(setting?.bank_account, payment.amount, payment.transaction_id)} width={200} height={200} alt="qrcode" />
                </div>
            </div>
...
export default MomoPaymentGuide