    ...
    return (
        <div className="flex items-center gap-2 lg:gap-3.5 lg:w-[400px] justify-end">
            <div className="flex items-center gap-2 me-0.5">
                ...
                >
                    <button className="dropdown-toggle btn btn-icon btn-icon-base btn-sm text-gray-600 hover:text-primary dropdown-open:text-primary">
                ...
                <div className="menu" data-menu="true">
                    ...
                    >
                        <button className="menu-toggle btn btn-icon btn-icon-base btn-sm text-gray-600 hover:text-primary dropdown-open:text-primary">
            ...
            <div className="menu" data-menu="true">
                <div
                    ...
                    data-menu-item-trigger="click|lg:click"
                >
                    <button className="menu-toggle btn btn-sm btn-dark">
                        Create
