...
export default function BookTitleTopBar() {
          ...
          <div className="grid">
            <div className="scrollable-x-auto">
              <div className="menu gap-3" data-menu="true">
                ...
                <MenuItem href={`/dashboard/book-titles/`} title="Edit Book Title" />

                <MenuItem href="/dashboard/book-titles/create" title="Create Book Title" />
              </div>
            </div>
          </div>
