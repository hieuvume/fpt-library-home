...
const columns: ReadonlyArray<Column<BorrowRecord>> = [
    ...
    },
    {
        ...
        accessor: "_id",
        Cell: ({ row: { original } }) => (
            <ActionCell editUrl={`/dashboard/librarian/${original._id}`} />
          ),
    },
];
                        ...
                        <div>
                            <div className="flex items-center space-x-2">
                                ...
                                >
                                    ...
                                    <option value="holding" className="text-blue-500 font-semibold">Holding</option>
                                    <option value="borrowing" className="text-green-500 font-semibold">Borrowing</option>
                                    <option value="canceled" className="text-red-500 font-semibold">Canceled</option>
                                    <option value="rejected" className="text-gray-500 font-semibold">Rejected</option>
                                    <option value="returned" className="text-blue-600 font-semibold">Returned</option>
                                    <option value="losted" className="text-gray-700 font-semibold">Losted</option>
                                </select>
                            </div>
                        </div>
                    </div>
